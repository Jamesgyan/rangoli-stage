...
const LoginPage = () => {
  ...
  return (
    <Layout>
      <section className="min-h-[calc(100vh-4rem)] bg-section rangoli-bg flex items-center justify-center py-12 px-4">
        <motion.div
          ...
          <Card className="shadow-xl border-0">
            ...
            <CardContent className="space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full gradient-saffron text-white font-heading font-semibold h-11">
